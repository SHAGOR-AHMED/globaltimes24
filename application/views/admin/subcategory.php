			...
			<div class="agile_top_w3_grids">
				 <div class="navbar navbar-inner block-header">
                    <div class="alert alert-info">All Subcategory &nbsp;
                        <a href="<?php print base_url('category/add_subcategory');?>">
                            ...
                            <tbody>
                            	...
                            	?> 
                                    <tr>
                                        ...
                                        <td class="center"><a href="<?php print base_url('category/edit_subcategory/'.$value->subcat_id);?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>|
                                        <a href="<?php print base_url('category/delete_subcategory/'.$value->subcat_id);?>" onclick="return confirm('Are you sure ?')"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                                    </tr>
                               <?php }?>
                            </tbody>
                        </table>
