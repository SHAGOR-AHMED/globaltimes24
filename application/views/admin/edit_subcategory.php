	...
	<div class="inner_content_w3_agile_info">
		<div class="agile_top_w3_grids">
			 <div class="block-content collapse in">
              <div class="span12">
                  <form action="<?php echo base_url('category/update_subcategory');?>" enctype="multipart/form-data" method="post">
                      <div class="control-group">
                        ...
                        <input type="hidden" name="subcat_id" value="<?php print $result->subcat_id;?>" class="form-control">
                      </div>
                      <br>
