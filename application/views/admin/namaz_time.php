                    ...
                    <div class="block-content collapse in">
                        <div class="span12">
                            <table id="sample-table-2" class="table table-striped table-bordered table-hover roni">
                                ...
                                <?php
                                    $i=1;
                                    foreach ($namazTime as $value) {
                                ?>
                                    <tr>
                                        <td class="center"><?php print $i++;?></td>
                                        <td class="center"><?php print $value->name;?></td>
                                        <td class="center"><?php print $value->start_time;?></td>
                                        <td class="center"><?php print $value->end_time;?></td>
                                        <td class="center">
                                            <a href="<?php print base_url('Ads/edit_namazTime/'.$value->id);?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
